...
def main_calc_destination_station_location(destination_station_location):
...
# open new csv query result and read into lex bot
	...
	if not rows :
		...
		return 'The train stations that we found for ' + destination_station_location + ' are: {}.'.format(rows) + 'Do you want to set one of those stations as your destination station? '

def return_StationName(intent_request):
	destination_station_location = intent_request['currentIntent']['slots']['destination_station_location']
	...
	return close(
		...
		'Fulfilled',
		{
			...
			'content': main_calc_destination_station_location(destination_station_location) 
...
def dispatch(intent_request):
    ...
    intent_name='GetDestinationStationLocation'
    
    # Dispatch to your bot's intent handlers
    if intent_name == 'GetDestinationStationLocation':
