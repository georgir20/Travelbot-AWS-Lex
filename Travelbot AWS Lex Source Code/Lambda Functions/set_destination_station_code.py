...
# open new csv query result and read into lex bot
	...
	return 'Ok we have set ' + destination_station_name + ' as your destination station. Do you now want to look up the direct connections for your selected start and destination? For that type "direct". '
